...
class LazyPropertyFactory<T> implements PropertyFactory<T> {
    ...
    static PropertyFactory<?> get(String preferenceName, Method method) {
                ...
                if (types.length == 1) {
                    ...
                    return new LazyPropertyFactory(Matcher.matchFrom(valueType)
                            .valueOf(Integer.class, intClass -> (PropertyFactory)
                                    preferences -> new Property.IntProperty(defaultKey, extractAnnotation(method, Config.IntItem.class), preferenceName, preferences))
                            .valueOf(Float.class, floatClass ->
                                    preferences -> new Property.FloatProperty(defaultKey, extractAnnotation(method, Config.FloatItem.class), preferenceName, preferences))
                            .valueOf(String.class, stringClass ->
                                    preferences -> new Property.StringProperty(defaultKey, extractAnnotation(method, Config.StringItem.class), preferenceName, preferences))
                            .valueOf(Boolean.class, booleanClass ->
                                    preferences -> new Property.BooleanProperty(defaultKey, extractAnnotation(method, Config.BooleanItem.class), preferenceName, preferences))
                            .valueOf(Long.class, longClass ->
                                    preferences -> new Property.LongProperty(defaultKey, extractAnnotation(method, Config.LongItem.class), preferenceName, preferences))
                            .valueOf(Serializable.class, serializableClass ->
                                    preferences -> new Property.SerializableProperty<>(defaultKey, extractAnnotation(method, Config.SerializableItem.class), preferenceName, preferences))
                            .typeOf(ParameterizedType.class, parameterizedType -> {
                                ...
                                if (Objects.equals(rawType, Set.class) && Objects.equals(actualTypeArguments[0], String.class)) {
                                    return preferences -> new Property.StringSetProperty(defaultKey, extractAnnotation(method, Config.StringSetItem.class), preferenceName, preferences);
                                } else {
